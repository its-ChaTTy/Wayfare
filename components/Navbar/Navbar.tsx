...
const Navbar: React.FC = () => {
  return (
    <nav className="block w-full max-w-screen-lg px-4 py-2 mx-auto bg-white shadow-md rounded-md lg:px-8 mt-5 relative z-50">
      <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
        <Link href="/">
          <div className="mr-4 block cursor-pointer py-1.5 text-base text-slate-800 font-semibold">
            Way<span className="italic">Fare</span>
          </div>
        </Link>
